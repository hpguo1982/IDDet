...
data_root = '/home/songmengyang/mmdect/data/coco/'
...
test_dataloader = dict(
    ...
    dataset=dict(
        _scope_='mmdet',
        ann_file='/home/songmengyang/mmdetection/data/coco/annotations/instances_val2017.json',
        backend_args=None,
...
test_evaluator = dict(
    _scope_='mmdet',
    ann_file=
    '/home/songmengyang/mmdect/data/coco/annotations/instances_val2017.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
train_dataloader = dict(
    ...
    dataset=dict(
        _scope_='mmdet',
        ann_file='/home/songmengyang/mmdetection/data/coco/annotations/instances_train2017.json',
        backend_args=None,
